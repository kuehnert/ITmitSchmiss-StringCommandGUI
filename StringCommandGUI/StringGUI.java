    ...
    static class GUI extends JFrame {
        ...
        private String[] populateList() {
            ...
            for (Method m : rMethods) {
                ...
                if (Modifier.isPublic(m.getModifiers()) && returnType.equals(String.class)
                        && Arrays.equals(params, PARAMS)) {
        ...
        private void convertText() {
            ...
            try {
                ...
                out = String.format("FEHLER beim Methodenaufruf von '%s'%nFehlerytp: %s", command,
                        e.getCause());
            }
